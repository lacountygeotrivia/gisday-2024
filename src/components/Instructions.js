            ...
            <div className="card align-self-center" style={{width: "80%", maxWidth: "500px"}}>
                ...
                <div className="card-body">
                    <ul>
						...
						<li>The circle color indicates if you're getting hotter or colder!</li>
						<li>The map will automatcially update with a popup alert once you have found the right location</li>
                        <li className="d-flex flex-column">
                            <img className="align-self-center" alt="" src="./viewfinder.png"/>
                        </li>
                        <li>Ask for a hint -- it won't cost you a thing</li>
                        <li>Optionally, opt to "Reveal", however, it counts against your score</li>
                    </ul>
                </div>
            </div>
        </div>    
